...
void main() {
  testWidgets('AppFeedback.success shows a SnackBar with the message', (tester) async {
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Builder(builder: (ctx) {
  ...
  testWidgets('AppFeedback.error shows a SnackBar with the message', (tester) async {
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: Builder(builder: (ctx) {
        return ElevatedButton(
