...
required=(
  .gitattributes AGENTS.md README.md CLAUDE.md GEMINI.md .fvmrc
  .github/copilot-instructions.md .cursor/rules/gamblock-ai.mdc
  docs/ai/README.md docs/ai/distribution-matrix.md docs/ai/manifest.yaml
...
for file in "${required[@]}"; do
  [[ -f "$ROOT_DIR/$file" ]] || { echo "missing AI/fresh-clone file: $file" >&2; exit 1; }
...
grep -Fq 'context_version: 2026-08-28.4' "$ROOT_DIR/docs/ai/manifest.yaml"
...
echo 'Flutter AI context verification passed'
