  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: (isActive ? AppColors.sage : AppColors.crimson).withValues(
            alpha: 0.2,
          ),
        ),
      ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  isActive
                      ? AppLocalizations.of(context)!.protectionActiveTitle
                      : AppLocalizations.of(context)!.protectionInactive,
