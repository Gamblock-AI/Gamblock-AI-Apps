...
class AppText {
  ...
  static const TextTheme textTheme = TextTheme(
    displayLarge: TextStyle(fontSize: 57, fontWeight: FontWeight.w800, letterSpacing: -0.25, height: 1.12),
    displayMedium: TextStyle(fontSize: 45, fontWeight: FontWeight.w800, letterSpacing: 0, height: 1.16),
    displaySmall: TextStyle(fontSize: 36, fontWeight: FontWeight.w700, letterSpacing: 0, height: 1.22),
    headlineLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, letterSpacing: 0, height: 1.25),
    headlineMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, letterSpacing: 0, height: 1.29),
    ...
    titleMedium: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, letterSpacing: 0.15, height: 1.50),
    ...
    labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.5, height: 1.45),
  );
}
