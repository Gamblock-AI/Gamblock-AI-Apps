...
class AppSpacing {
  ...
  /// settings all share this). Bottom inset (148) ensures the lowest card
  /// scrolls fully clear of the floating bottom dock and center FAB.
  static const EdgeInsets screenPadding = EdgeInsets.fromLTRB(lg, md, lg, 148);
}
