...
class AppColors {
  ...
  // Interactive accent aliases — aligned with the website system. The web has
  // no separate "bright blue" family: interactive accents use sky/azure/navy,
  // so these legacy names now resolve to the web palette. `blueAccentGradient`
  // is a sky→azure wash (matches the website's cyan accent surfaces).
  static const blueAccent = Color(0xFF3DD6F5); // sky
  static const blueAccentLight = Color(0xFF8FDEF2);
  static const blueAccentSoft = Color(0xFFE6F8FC);
  static const violetAccent = Color(0xFFDCEBFB); // azure
  static const violetAccentSoft = Color(0xFFEFF6FE);

  // Surfaces (light) — matches the website dashboard canvas (#F5F8FC mesh).
  static const surface = Color(0xFFFFFFFF); // card
  static const background = Color(0xFFF5F8FC); // page base
  ...
  static const meshGradient = LinearGradient(
    ...
    colors: [Color(0xFFE1F3FB), Color(0xFFECF4FD), Color(0xFFF5FAFE)],
  );

  /// Sky accent gradient used by the FAB and active pills — a sky→azure wash
  /// matching the website's cyan accent surfaces.
  static const blueAccentGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFFBFE9F5), Color(0xFF3DD6F5), Color(0xFF2BB4D4)],
  );
